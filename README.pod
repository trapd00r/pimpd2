...
PKGBUILD in AUR:  L<http://aur.archlinux.org/packages.php?ID=45042>

Example config: L<https://github.com/trapd00r/pimpd2/raw/master/doc/pimpd2.conf.example>

=head2 CPAN

This is the preferred way of installing B<pimpd2> for users. Dependencies will
be resolved automagically.
...
Install dependencies from CPAN. As root:

    cpan Term::ExtendedColor Term::ReadLine::Gnu Config::General Audio::MPD \
         Time::Duration

As user:

    git clone git://github.com/trapd00r/pimpd2.git
    cd pimpd2
    perl Makefile.PL
    make && su -c 'make install'
    cp doc/pimpd2.conf.example $HOME/.pimpd2.conf
...
Report bugs and/or feature requests to <magnus@trapd00r.se>, on L<rt.cpan.org>
or L<http://github.com/trapd00r/pimpd2/issues>.

=head1 COPYRIGHT

Copyright 2009, 2010, 2011 the B<pimpd2> L</AUTHOR> and L</CONTRIBUTORS> as
listed above.
